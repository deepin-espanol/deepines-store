...
class Dialog(QDialog):
    ...
    def initUi(self):
        ...
        self.label_8.setText(
            "Diseño: Jhalo @jhalo; André @Dziban; Alejandro @durantdurant")
        ...
        self.label_13.setText(
            "Colaboradores: Alvaro @G4SP3R; Omi @peteromio; Opik @Prophaniti; Pablo @dev86x; Jose @ProgramacionJS; Jorge @seiyukaras; @n1coc4cola; Oscar @oscararg; Jorge @jotakenobi")
