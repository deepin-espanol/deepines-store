...
class Dialog(QDialog):
  ...
  def initUi(self):
    ...
    self.label_6.setText("Proyecto: @Xhafas ")
    self.verticalLayout.addWidget(self.label_6)
    self.label_4 = QLabel(self)
    self.label_4.setAlignment(Qt.AlignCenter)
    self.label_4.setFont(font)
    self.label_4.setText("Desarrollo: @SebTrujillo")
    ...
    self.label_7.setText("Diseño: @Akibaillusion @Dziban @jhalo @durantdurant")
    self.verticalLayout.addWidget(self.label_7)
    self.label_10 = QLabel(self)
    self.label_10.setAlignment(Qt.AlignCenter)
    self.label_10.setFont(font)
    self.label_10.setText("Redaccion: @igatjens")
    self.label_10.setObjectName("label_10")
    self.verticalLayout.addWidget(self.label_10)
    self.label_8 = QLabel(self)
    self.label_8.setAlignment(Qt.AlignCenter)
    self.label_8.setText("Sys admin: @fenoll @geekmidget")
    ...
    self.label_9.setText("www.deepinenespañol.com")
